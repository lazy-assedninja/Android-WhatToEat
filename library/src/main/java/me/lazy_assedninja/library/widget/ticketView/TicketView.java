...
import me.lazy_assedninja.library.R;
...
public class TicketView extends View {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mBackgroundColor = typedArray.getColor(R.styleable.TicketView_ticketBackgroundColor, ContextCompat.getColor(context, android.R.color.white));
            mScallopRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketScallopRadius, DisplayUtil.dpToPx(20f, context));
            ...
            mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketBorderWidth, DisplayUtil.dpToPx(2f, context));
            mBorderColor = typedArray.getColor(R.styleable.TicketView_ticketBorderColor, ContextCompat.getColor(context, android.R.color.black));
            ...
            mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerWidth, DisplayUtil.dpToPx(2f, context));
            mDividerColor = typedArray.getColor(R.styleable.TicketView_ticketDividerColor, ContextCompat.getColor(context, android.R.color.darker_gray));
            mDividerDashLength = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerDashLength, DisplayUtil.dpToPx(8f, context));
            mDividerDashGap = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerDashGap, DisplayUtil.dpToPx(4f, context));
            mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketCornerRadius, DisplayUtil.dpToPx(4f, context));
            mDividerPadding = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerPadding, DisplayUtil.dpToPx(10f, context));
            float elevation = 0f;
            ...
            mShadowColor = typedArray.getColor(R.styleable.TicketView_ticketShadowColor, ContextCompat.getColor(context, android.R.color.black));
    ...
    private void setShadowBlurRadius(float elevation) {
        float maxElevation = DisplayUtil.dpToPx(24f, getContext());
