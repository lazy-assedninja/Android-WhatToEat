...
public class AndroidX {
    ...
    public static final String NAVIGATION_UI = "androidx.navigation:navigation-ui:"
            + DependenciesVersion.NAVIGATION;
    public static final String NAVIGATION_FRAGMENT = "androidx.navigation:navigation-fragment:"
            + DependenciesVersion.NAVIGATION;
    public static final String ROOM = "androidx.room:room-runtime:"
            + DependenciesVersion.ROOM;
    public static final String ROOM_COMPILER = "androidx.room:room-compiler:"
            + DependenciesVersion.ROOM;
