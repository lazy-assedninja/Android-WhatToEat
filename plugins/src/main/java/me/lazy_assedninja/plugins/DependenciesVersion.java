...
public class DependenciesVersion {
    ...
    public static final String DAGGER_HILT = "2.38.1";
    ...
    // Test
    public static final String ANDROIDX_ARCH_CORE = "2.1.0";
    public static final String ANDROIDX_JUNIT = "1.1.2";
    public static final String ANDROIDX_ESPRESSO = "3.3.0";
    public static final String JUNIT = "4.13.1";
    public static final String MOCKITO = "2.25.0";
    public static final String MOCK_WEB_SERVER = "4.9.1";
}